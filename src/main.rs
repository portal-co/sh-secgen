fn main() -> std::io::Result<()> {
    ...
    match ty.as_str() {
        ...
        _ => {
            eprintln!("invalid key type; valid ones are signing/ed25519, kem/xwing, signing/falcon/1024, signing/falcon/512. you can also initialize a repo with git/init")
        }
    };
    Ok(())
}
